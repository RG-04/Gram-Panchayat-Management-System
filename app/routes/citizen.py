...
def statistics():
    ...
    if category == "education":
        ...
        male_literacy_rate, female_literacy_rate = db.execute_query(
            citizen_queries["gender_literacy_query"]
        )
        ...
        education_stats = {
            ...
            "schools": [
                {
                    "name": school[1],
                    "current_students": school[2],
                    "total_students": school[3],
                }
        ...
        health_stats = {
            ...
            "hospitals": [
                {"name": hospital[1], "beds": hospital[3], "address": hospital[2]}
        ...
        agricultural_percentage = (
            db.execute_query(citizen_queries["agricultural_percentage_query"])[0][0]
            or 0
        )
        organic_percentage = (
            db.execute_query(citizen_queries["organic_percentage_query"])[0][0] or 0
        )
        crop_types = [
            row[0] for row in db.execute_query(citizen_queries["crop_types_query"])
        ]
        ...
        agriculture_stats = {
            ...
            "irrigated_area": round(
                float(agricultural_area) * 0.6, 2
        ...
        income_distribution = db.execute_query(
            citizen_queries["income_distribution_query"]
        )
        ...
        demographic_stats = {
            ...
            "gender_distribution": {"labels": gender_labels, "values": gender_values},
            "sex_ratio": sex_ratio,
            "population_pyramid": {
            ...
            "income_distribution": {"labels": income_labels, "values": income_values},
        }
...
def profile():
    ...
    for cert in certificates:
        ...
        certificates_by_category[category].append(
            {"category": cert[0], "name": cert[1], "date_issued": cert[2]}
        )
...
def education():
    ...
    return render_template(
        "citizen/education.html", education=education, schools=schools
    )
